  ...
  server.tool(
    ...
    async ({ startDate, endDate, timeUnit, category, keyword, device, gender, ages }) => {
      try {
        ...
        const response = await naverClient.getKeywordByDevice(request);
        return {
          content: [{ type: "text", text: formatResponseAsText(response) }]
        };
      } catch (error: any) {
  ...
  server.tool(
    ...
    async ({ startDate, endDate, timeUnit, category, keyword, device, gender, ages }) => {
      try {
        ...
        const response = await naverClient.getKeywordByGender(request);
        return {
          content: [{ type: "text", text: formatResponseAsText(response) }]
        };
      } catch (error: any) {
  ...
  server.tool(
    ...
    async ({ startDate, endDate, timeUnit, category, keyword, device, gender, ages }) => {
      try {
        ...
        const response = await naverClient.getKeywordByAge(request);
        return {
          content: [{ type: "text", text: formatResponseAsText(response) }]
        };
      } catch (error: any) {
